      ...
      <div id="login-form" class="card m-auto p-2">
          <div class="card-body">
              <form name="login-form" class="login-form" action="home.php" method="post" onsubmit="return validateCredentials();">
                  <div class="logo">
                      <img src="images/prof.png" style="width: 20%" class="profile"/>
                      <h1 class="logo-caption"><span class="text-white-50">Login</span></h1>
                  </div> <!-- logo class -->
                  <div class="input-group form-group">
                      <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-user text-white"></i></span>
                      </div>
                      <input name="username" type="text" class="form-control" placeholder="Enter username" onkeyup="validate();" required>
                  </div> <!--input-group class -->
                  <div class="input-group form-group">
                      <div class="input-group-prepend">
                          <span class="input-group-text"><i class="fas fa-key text-white"></i></span>
                      </div>
                      <input name="password" type="password" class="form-control" placeholder="Enter password" onkeyup="validate();" required>
                  </div> <!-- input-group class -->
                  <div class="form-group">
                      <button class="btn btn-default btn-block btn-custom rounded-pill"style="width:30%;margin-right: auto;margin-left: auto;">Login</button>
                  </div>
              </form><!-- form close -->
          ...
          <div class="card-body">
              <div name="login-form" class="login-form">
                  <div class="logo">
                      ...
                      <h1 class="logo-caption"><span class="text-white-50"></span>Forgot <span class="text-white-50">Password</span></h1>
                  </div> <!-- logo class -->

                  <div id="email-number-fields">
                      <p class="h6 text-center text-light">Enter email and contact to reset username and password<p>
                      <div class="input-group form-group">
                          <div class="input-group-prepend">
                      ...
                      <div class="form-group">
                          <button class="btn btn-default btn-block btn-custom rounded-pill" style="width: 30%;margin-right: auto;margin-left: auto" onclick="verifyEmailNumber();">Verify</button>
                      </div>
                  </div>
                  ...
                  <div id="username-password-fields" style="display: none;">
                      ...
                      <div class="form-group">
                          <button class="btn btn-default btn-block btn-custom rounded-pill" style="width: :30%;margin-left: auto;margin-right: auto;" onclick="updateUsernamePassword();">Reset Password</button>
                      </div>
                  </div>
              </div><!-- form close -->
